...
`cv2.warpPerspective`
![Perspective Transform](pictures/Advanced Lane Finding/Perspective Transform.png)
...
![Histogram of Thresholded](pictures/Advanced Lane Finding/Histogram.png)
![Sliding Windows](pictures/Advanced Lane Finding/Sliding Windows.png)
...
![Lane curve fit](pictures/Advanced Lane Finding/Polyfit.png)
**b. curvature calculation**
I get the curvature by pixel form following formula:
![Curvature Calculation](pictures/Advanced Lane Finding/Curvature Calculation.png)
...
![Measurement Result](pictures/Advanced Lane Finding/Measurement result.png)
...
![CTE difiniiton](pictures/Advanced Lane Finding/CTE.jpg)
...
![HOG Feature](pictures/Traffic Sign Detection/HOG Feature.png)
...
![Dataset for Traffic Sign Detection(Sign & non-sign)](pictures/Traffic Sign Detection/Training Data.png)
...
![SVC Accuracy](pictures/Traffic Sign Detection/Classifier Accuracy.png)
...
![Multi-scale Sliding Window Search](pictures/Traffic Sign Detection/multi-scale window.png)
...
![First Precess Result of the Detector](pictures/Traffic Sign Detection/false positive.png)
...
![Final Search Result within Heat-map](pictures/Traffic Sign Detection/Heatmap.png)
...
![All Sorts of Traffic Sign](pictures/Traffic Sign Classifier/Traffic Sign Sorts.png)
The distribution of the dataset is as follow:
![Unbalanced Distribution of Dataset](pictures/Traffic Sign Classifier/Traffic Sign Sorts.png)
...
![Deep CNN Architecture](pictures/Traffic Sign Classifier/CNN Architecture.png)
...
![Effect of Data Augment in Different Ways](pictures/Traffic Sign Classifier/Data Augment.png)

**5. Model Performance**
Here is the loss function value history through 100 training epochs:
![Loss function of training and validation dataset throughout the training](pictures/Traffic Sign Classifier/Loss History.png)
![Precision & Recall for All of Traffic Sign's Sorts](pictures/Traffic Sign Classifier/Precision & Recall for all of Traffic Sign's Sorts.png)
...
![Final Output for Traffic Sign Recognition](pictures/Traffic Sign Classifier/Final Output for Traffic Sign Recognition.png)
